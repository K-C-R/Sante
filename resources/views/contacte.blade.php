                ...
                <div class="row justify-content-around">
                    <div class="col-lg-5">
                        ...
                        <div class="feature-box fbox-sm mb-3">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott text-larger fw-normal mb-2"><a href="tel:+122-55412474">(1) 22 55412474</a></h3>
                            </div>
                        </div>
                        <div class="feature-box fbox-sm mb-5">
                            ...
                            <div class="fbox-content">
                                <h3 class="nott text-larger fw-normal mb-2"><a href="mailto:noreply@canvas.com">noreply@canvas.com</a></h3>
                            </div>
                        </div>
                            ...
                            <form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post" novalidate="novalidate">
                                ...
                                <div class="row">
                                    <div class="col-12 form-group mb-4">
                                        ...
                                        <input type="text" id="template-contactform-name" name="template-contactform-name" value="" class="rounded-pill form-control required valid">
                                    </div>

                                    <div class="col-12 form-group mb-4">
                                        <label class="nott ls0" for="template-contactform-email">Email <small>*</small></label>
                                        <input type="email" id="template-contactform-email" name="template-contactform-email" value="" class="required email rounded-pill form-control valid">
                                    </div>

                                    <div class="col-12 form-group mb-4">
                                        <label class="nott ls0" for="template-contactform-message">Message <small>*</small></label>
                                        <textarea class="required rounded-5 form-control valid" id="template-contactform-message" name="template-contactform-message" rows="6" cols="30"></textarea>
                                    </div>
